...
class BaseModel(nn.Module):
    ...
    def init_criterion(self):
        """Initialize the loss critenrion for the BaseModel."""
...
class DetectionModel(BaseModel):
    ...
    def __init__(self, cfg="YAML/DyRFA-Net.yaml", ch=3, nc=None, verbose=True):  # model, input channels, number of classes
...
def attempt_load_weights(weights, devicfe=None, inplace=True, fuse=False):
    ...
    for i, (f, n, m, args) in enumerate(d['backbone'] + d['head']):
        if 'nn.' in m:
            ...
            try:
                ...
                raise KeyError(f"Module {m} not found. Make sure it is defined and imported correctly.")
    # Args
